...
import com.emirhan.task.Type;

import java.util.*;
import java.util.stream.Collectors;

import static com.emirhan.task.DishData.getAll;
...
public class CollectorsDemo {
    ...
    public static void main(String[] args) {
        ...
        Double caloryAverage = getAll().stream()
                .collect(Collectors.averagingInt(Dish::getCalories));

        System.out.println(caloryAverage);
        ...
        Map<Boolean, List<Dish>> veggieDish = getAll().stream()
